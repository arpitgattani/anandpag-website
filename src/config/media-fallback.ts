/**
 * Static Media Configuration Fallback
 * 
 * This file serves as a fallback when /public/media-config.json cannot be loaded.
 * Used in development when the public folder might not be served correctly.
 */

import type { MediaConfig } from '../app/contexts/MediaConfigContext';

export const MEDIA_CONFIG_FALLBACK: MediaConfig = {
  videos: {
  ...
  premiumCaseStudyImages: {
    manufacturingAutomation: 'https://images.unsplash.com/photo-1768796372362-05c256e61d8c?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxtb2Rlcm4lMjBtYW51ZmFjdHVyaW5nJTIwZmFjdG9yeSUyMGF1dG9tYXRpb258ZW58MXx8fHwxNzcwOTMwNTIwfDA&ixlib=rb-4.1.0&q=80&w=1080',
    retailInventory: 'https://images.unsplash.com/photo-1759197894183-ffffa3c7fcd4?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxyZXRhaWwlMjBzdG9yZSUyMGludmVudG9yeSUyMHRlY2hub2xvZ3l8ZW58MXx8fHwxNzcwOTMwNTIwfDA&ixlib=rb-4.1.0&q=80&w=1080',
    healthcareTechnology: 'https://images.unsplash.com/photo-1766299892693-2370a8d47e23?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxoZWFsdGhjYXJlJTIwaG9zcGl0YWwlMjB0ZWNobm9sb2d5fGVufDF8fHx8MTc3MDkzMDUyMHww&ixlib=rb-4.1.0&q=80&w=1080'
  },
  testimonialImages: {
  ...
  megaMenuImages: {
    solutions: {
      compliance: 'https://images.unsplash.com/photo-1762341114881-669da93fef88?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxlbnRlcnByaXNlJTIwb2ZmaWNlJTIwdGVjaG5vbG9neXxlbnwxfHx8fDE3NzA5MjIwODJ8MA&ixlib=rb-4.1.0&q=80&w=1080',
      analytics: 'https://images.unsplash.com/photo-1608222351212-18fe0ec7b13b?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxidXNpbmVzcyUyMGFuYWx5dGljcyUyMGRhc2hib2FyZHxlbnwxfHx8fDE3NzA3OTY2NTd8MA&ixlib=rb-4.1.0&q=80&w=1080',
      processFactory: 'https://images.unsplash.com/photo-1720036236694-d0a231c52563?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxhdXRvbWF0ZWQlMjBmYWN0b3J5JTIwd29ya2Zsb3d8ZW58MXx8fHwxNzcwOTIyMDgzfDA&ixlib=rb-4.1.0&q=80&w=1080'
    },
    industries: {
      manufacturing: 'https://images.unsplash.com/photo-1767281075989-7571356d477e?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxtYW51ZmFjdHVyaW5nJTIwZmFjdG9yeSUyMGF1dG9tYXRpb258ZW58MXx8fHwxNzcwODM5MzAxfDA&ixlib=rb-4.1.0&q=80&w=1080',
      healthcare: 'https://images.unsplash.com/photo-1758691462848-ba1e929da259?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxoZWFsdGhjYXJlJTIwbWVkaWNhbCUyMHRlY2hub2xvZ3l8ZW58MXx8fHwxNzcwODM5MzAwfDA&ixlib=rb-4.1.0&q=80&w=1080',
      retail: 'https://images.unsplash.com/photo-1761795084688-bb007bc51697?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxyZXRhaWwlMjBzdG9yZSUyMHRlY2hub2xvZ3l8ZW58MXx8fHwxNzcwODk1MTQ5fDA&ixlib=rb-4.1.0&q=80&w=1080',
      financial: 'https://images.unsplash.com/photo-1571715268998-d6e79bed5fc9?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxmaW5hbmNpYWwlMjBiYW5raW5nJTIwdGVjaG5vbG9neXxlbnwxfHx8fDE3NzA4OTU1MjB8MA&ixlib=rb-4.1.0&q=80&w=1080'
    }
  },
  partnerCredibilityImages: {
    ...
    microsoft: {
      card: 'https://images.unsplash.com/photo-1671944378859-08bcfa15a280?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxtaWNyb3NvZnQlMjBhenVyZSUyMGNsb3VkJTIwY29tcHV0aW5nfGVufDF8fHx8MTc3MDk1NDMxMnww&ixlib=rb-4.1.0&q=80&w=1080',
      header: 'https://images.unsplash.com/photo-1671944378859-08bcfa15a280?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxtaWNyb3NvZnQlMjBhenVyZSUyMGNsb3VkJTIwY29tcHV0aW5nfGVufDF8fHx8MTc3MDk1NDMxMnww&ixlib=rb-4.1.0&q=80&w=1080'
    },
    salesforce: {
      card: 'https://images.unsplash.com/photo-1698759178588-ff05b12fba6b?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxidXNpbmVzcyUyMHRlY2hub2xvZ3klMjBhYnN0cmFjdCUyMGJsdWV8ZW58MXx8fHwxNzcwODkyMjUwfDA&ixlib=rb-4.1.0&q=80&w=1080',
      header: 'https://images.unsplash.com/photo-1698759178588-ff05b12fba6b?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxidXNpbmVzcyUyMHRlY2hub2xvZ3klMjBhYnN0cmFjdCUyMGJsdWV8ZW58MXx8fHwxNzcwODkyMjUwfDA&ixlib=rb-4.1.0&q=80&w=1080'
    }
  },
  heroFloatingIcons: {
  ...
  careersImages: {
    team: 'https://images.unsplash.com/photo-1690383922983-90d7a4658ef3?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxkaXZlcnNlJTIwdGVjaCUyMHRlYW0lMjBvZmZpY2UlMjBjYXN1YWwlMjBsYXVnaGluZ3xlbnwxfHx8fDE3NzEyNzAyNjN8MA&ixlib=rb-4.1.0&q=80&w=1080'
  },
  blogImages: {
  ...
  technologyImages: {
    enterpriseTech: 'https://images.unsplash.com/photo-1558494949-ef010cbdcc31?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxkYXRhJTIwY2VudGVyJTIwc2VydmVycyUyMHRlY2hub2xvZ3l8ZW58MXx8fHwxNzcwODY1MzgzfDA&ixlib=rb-4.1.0&q=80&w=1080',
    microsoft: 'https://images.unsplash.com/photo-1671944378859-08bcfa15a280?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxtaWNyb3NvZnQlMjBhenVyZSUyMGNsb3VkJTIwY29tcHV0aW5nfGVufDF8fHx8MTc3MDk1NDMxMnww&ixlib=rb-4.1.0&q=80&w=1080',
    salesforce: 'https://images.unsplash.com/photo-1698759178588-ff05b12fba6b?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxidXNpbmVzcyUyMHRlY2hub2xvZ3klMjBhYnN0cmFjdCUyMGJsdWV8ZW58MXx8fHwxNzcwODkyMjUwfDA&ixlib=rb-4.1.0&q=80&w=1080'
  }
};
